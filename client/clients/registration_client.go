...
func NewRegistrationClient(ctx context.ClientContext) (*registrationClient, error) {
	...
	senderPk, err := config.ReadFileToString(cfg.Voting.SystemManagerSenderPrivateKeyFile)
	if err != nil {
	...
	signerPkString, err := config.ReadFileToString(cfg.Voting.SigningPolicyPrivateKeyFile)
	if err != nil {
	...
	return &registrationClient{
		...
		identityAddress: cfg.Voting.IdentityAddress,
	}, nil
}
