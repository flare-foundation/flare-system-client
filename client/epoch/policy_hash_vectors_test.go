...
// and RelayMainDeployed.sol; hashes read back via toSigningPolicyHash, cast-checked.
const (
...
// Live Coston2 Relay (0xa10B672D1c62e5457b17af63d4302add6A99d7dE, epoch 5956): eth_call
// setSigningPolicy returns the hash the deployed bytecode stores for these 153 bytes.
const (
