...
// EpochsFromChain returns the voting round timing, reward epoch config, random number
// protocol id and prolonged-epoch threshold factor from the relay contract.
