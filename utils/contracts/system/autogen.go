...
// Submit3Alligned is a free data retrieval call binding the contract method 0xb251d7a0.
//
// Solidity: function submit3Alligned() view returns(bool)
func (_FlareSystemManager *FlareSystemManagerCaller) Submit3Alligned(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _FlareSystemManager.contract.Call(opts, &out, "submit3Alligned")
...
//
// Solidity: function submit3Alligned() view returns(bool)
func (_FlareSystemManager *FlareSystemManagerSession) Submit3Alligned() (bool, error) {
	return _FlareSystemManager.Contract.Submit3Alligned(&_FlareSystemManager.CallOpts)
}

// Submit3Alligned is a free data retrieval call binding the contract method 0xb251d7a0.
//
// Solidity: function submit3Alligned() view returns(bool)
func (_FlareSystemManager *FlareSystemManagerCallerSession) Submit3Alligned() (bool, error) {
	return _FlareSystemManager.Contract.Submit3Alligned(&_FlareSystemManager.CallOpts)
}
