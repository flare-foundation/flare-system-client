...
func (_Submission *SubmissionCaller) FlareSystemsManager(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Submission.contract.Call(opts, &out, "flareSystemsManager")
...
//
// Solidity: function flareSystemsManager() view returns(address)
func (_Submission *SubmissionSession) FlareSystemsManager() (common.Address, error) {
	return _Submission.Contract.FlareSystemsManager(&_Submission.CallOpts)
}

// FlareSystemsManager is a free data retrieval call binding the contract method 0xfaae7fc9.
//
// Solidity: function flareSystemsManager() view returns(address)
func (_Submission *SubmissionCallerSession) FlareSystemsManager() (common.Address, error) {
	return _Submission.Contract.FlareSystemsManager(&_Submission.CallOpts)
}
...
func (_Submission *SubmissionCaller) TimelockedCalls(opts *bind.CallOpts, selector [4]byte) (struct {
	AllowedAfterTimestamp *big.Int
	EncodedCall           []byte
}, error) {
	var out []interface{}
	err := _Submission.contract.Call(opts, &out, "timelockedCalls", selector)
...
//
// Solidity: function timelockedCalls(bytes4 selector) view returns(uint256 allowedAfterTimestamp, bytes encodedCall)
func (_Submission *SubmissionSession) TimelockedCalls(selector [4]byte) (struct {
	AllowedAfterTimestamp *big.Int
	EncodedCall           []byte
}, error) {
	return _Submission.Contract.TimelockedCalls(&_Submission.CallOpts, selector)
}

// TimelockedCalls is a free data retrieval call binding the contract method 0x74e6310e.
//
// Solidity: function timelockedCalls(bytes4 selector) view returns(uint256 allowedAfterTimestamp, bytes encodedCall)
func (_Submission *SubmissionCallerSession) TimelockedCalls(selector [4]byte) (struct {
	AllowedAfterTimestamp *big.Int
	EncodedCall           []byte
}, error) {
	return _Submission.Contract.TimelockedCalls(&_Submission.CallOpts, selector)
